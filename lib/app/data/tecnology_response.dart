class TecnologyResponse {
  bool? succsess; // Deklarasi variabel bool dengan nullable (?)
  String? message; // Deklarasi variabel String dengan nullable (?)
  List<Data>?
      data; // Deklarasi variabel List yang berisi objek dari kelas Data dengan nullable (?)

  TecnologyResponse(
      {this.succsess,
      this.message,
      this.data}); // Konstruktor dengan parameter opsional

  TecnologyResponse.fromJson(Map<String, dynamic> json) {
